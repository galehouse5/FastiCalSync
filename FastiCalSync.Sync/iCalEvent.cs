...
namespace FastiCalSync.Sync
{
    public class iCalEvent : IEvent
    {
        ...
        {
            get => InnerEvent.DtStart.HasDate && !InnerEvent.DtStart.HasTime ? InnerEvent.DtStart.Date : (DateTime?)null;
            set => throw new NotSupportedException();
        }
        ...
        {
            get => InnerEvent.DtEnd.HasDate && !InnerEvent.DtEnd.HasTime ? InnerEvent.DtEnd.Date : (DateTime?)null;
            set => throw new NotSupportedException();
        }
