...
namespace FastiCalSync.Sync
{
    public class GCalService
    {
        ...
        public async Task<Calendar> Create(Calendar calendar)
        {
        ...
        {
            var request = service.Calendars.Delete(calendarID);
            await request.ExecuteAsync();
        }

        public async Task<IReadOnlyCollection<Event>> ReadEvents(string calendarID)
        {
